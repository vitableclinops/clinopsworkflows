#!/bin/bash
# Installs the launchd agent that runs /tddaily-availability-report every day at 8:00 AM.
...
PLIST_NAME="com.vitablehealth.clinops-tddaily-availability-report.plist"
PLIST_SRC="$REPO_DIR/scripts/$PLIST_NAME"
PLIST_DEST="$HOME/Library/LaunchAgents/$PLIST_NAME"
SCRIPT="$REPO_DIR/scripts/run-tddaily-availability-report.sh"
...
echo "✓ Scheduled: TD daily availability report will run every day at 8:00 AM"
echo "  Repo:   $REPO_DIR"
echo "  Log:    $HOME/.clinops-tddaily-availability-report.log"
echo ""
